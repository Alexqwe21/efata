...
<body>
    ...
    <main>
        ...
        <section class="bolas_de_volei">
            <article class="site">
                <div class="bolas_volei">
                    <img src="assets/img/bola_vo.svg" alt="volei">
                    <img src="assets/img/bola_vo.svg" alt="volei">
                </div>
                <div class="texto-centro">
                    <div class="texto">
                        <strong>Curtiu nosso projeto? Então vem viver a emoção do vôlei com a gente!</strong>
                    </div>
                </div>
            ...
            <article class="site">
                <div class="group">
                    ...
                    <div class="coluna">
                        ...
                        <div class="atletas">
                            <h3>Moldando atletas com treinamento focado</h3>
                        </div>
        ...
        <section class="carroselCampeonato">
            ...
            <!-- Contador dinâmico -->
            <div class="contador-carrossel">1 / 3</div>
            ...
            <article class="site">
                <div class="group">
                    ...
                    <div class="coluna">
                        ...
                        <div class="atletas">
                            <h3>Conheça nossos guerreiros do vôlei</h3>
                        </div>
